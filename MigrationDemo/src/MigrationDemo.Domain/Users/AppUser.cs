...
namespace MigrationDemo.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update MigrationDemoDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update MigrationDemoEfCoreEntityExtensionMappings to extend the IdentityUser entity
