...
namespace MigrationDemo.EntityFrameworkCore
{
    ...
    public class MigrationDemoEntityFrameworkCoreModule : AbpModule
    {
        ...
        {
            context.Services.AddAbpDbContext<MigrationDemoDbContext>(options =>
            {
            ...
            Configure<AbpDbContextOptions>(options =>
            {
                 ...
                 * See also MigrationDemoMigrationsDbContextFactory for EF Core tooling. */
                options.UseMySQL();
            });
        }
    }
